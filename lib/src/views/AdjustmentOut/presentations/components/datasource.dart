...
class InvAdjOutDataSource extends DataGridSource {
  late BuildContext cntx;
  List<InvAdjustmentOutHeaderModel> datas;
  List<InvAdjustmentOutHeaderModel>? selectedDatas;
  int endIndex = 0;
  int rowsPerPage;
  List<DataGridRow> dataGridRows = [];
  final VoidCallback? onRefresh;
  final void Function(int) onPageChanged;
  final void Function(InvAdjustmentOutHeaderModel)? onSelected;
  final void Function(InvAdjustmentOutHeaderModel)? onDeselected;
  ...
  InvAdjOutDataSource(
    ...
    dataGridRows = datas.asMap().entries.map((dataEntries) {
      ...
      InvAdjustmentOutHeaderModel data = dataEntries.value;
      InvAdjustmentOutHeaderModel? selectedData =
                ...
                showDialog(
                  ...
                  builder: (context) {
                    return ContentDialog(
                      ...
                      content: InvAdjustmentOutDetailsDialog(
                        details: datas[index].rows!,
                      ),
                    );
                  },
                );
