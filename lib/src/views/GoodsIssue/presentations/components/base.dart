...
class BaseGoodsIssue extends StatefulWidget {
  const BaseGoodsIssue({
    super.key,
  ...
  @override
  State<BaseGoodsIssue> createState() => _BaseGoodsIssueState();
}

class _BaseGoodsIssueState extends State<BaseGoodsIssue> {
