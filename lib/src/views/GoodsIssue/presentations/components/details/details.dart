import '/src/views/GoodsIssue/data/models/row_model.dart';
...
class GoodsIssueDetailsDialog extends StatefulWidget {
  const GoodsIssueDetailsDialog({super.key, this.details = const []});

  final List<GoodsIssueRowModel> details;

  @override
  State<GoodsIssueDetailsDialog> createState() =>
      _GoodsIssueDetailsDialogState();
}

class _GoodsIssueDetailsDialogState extends State<GoodsIssueDetailsDialog> {
...
class _TableSettings {
  ...
  static DataGridRow dataGrid(GoodsIssueRowModel data) {
    return DataGridRow(
